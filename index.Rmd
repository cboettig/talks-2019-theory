...
- Carrying capacity $C$, Allee threshold $A$, available territory $\beta$

```{r watson2019, echo=FALSE, message=FALSE, warning=FALSE, fig.height=4.5}
library(tidyverse)
